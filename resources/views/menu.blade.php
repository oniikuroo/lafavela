...
@section('head')
        ...
        @php
            $seoTitle = __('site.menu_title');
            $seoDescription = __('site.menu_description');
            $seoUrl = url()->current();
    ...
    <a href="https://www.instagram.com/lafavela.sevilla/" target="_blank" rel="noopener">
        <svg class="social-icon" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <section class="menu-hero">
                <div>
                    <h1 class="menu-title">{{ $menuContent['heading'] ?? __('site.menu_heading') }}</h1>
                    <div class="divider" aria-hidden="true"></div>
                    <p class="menu-subtitle">{{ $menuContent['subtitle'] ?? __('site.menu_subtitle') }}</p>
                    <div class="menu-ad">{{ $menuContent['ad'] ?? __('site.menu_shots_ad') }}</div>
                </div>
...
@section('scripts')
        <script>
            function setLanguage(lang) {
                const routes = {
                    es: @json(route('menu', ['lang' => 'es'])),
                    en: @json(route('menu', ['lang' => 'en'])),
                    pt: @json(route('menu', ['lang' => 'pt'])),
                };
